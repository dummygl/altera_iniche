...
/*
 * Altera Niche Stack Nios port modification:
 * Display license reminder message unless it has been disabled
 */
#ifndef ALT_INICHE_SUPRESS_LICENSE_WARNING
   /* Display license notification. */
   printf("=============== Software License Reminder ================\n");
   printf("This software project uses an unlicensed version of the NicheStack TCP/IP\n");
   printf("Network Stack - Nios II Edition. If you want to ship resulting object\n");
   printf("code in your product, you must purchase a license for this software from\n");
   printf("Altera. For information go to: \"http://www.altera.com/nichestack\"\n");
   printf("=====================================================\n");
#endif /* ALT_INICHE_SUPRESS_LICENSE_WARNING */
